...
\begin{titlepage}
    ...
    \vspace{0.8cm}
    {\large Version 1.2.0 Nightly Build\par}
    \vfill
    \begin{tabular}{rl}
...
The Electrical \& Computer Project Repository Hub simplifies student project submission by replacing manual Git steps with a guided website workflow. It keeps source code and student project storage separate, supports automated GitHub pull request handling, includes status checks for admins, and provides a structured browsing experience for accepted project files. With version 1.2.0 nightly build, the platform is ready for continued deployment testing and frontend hosting preparation.
